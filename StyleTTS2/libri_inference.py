...
class StyleTTS2Inference:
    ...
    def load_models(self, model_path):
        ...
        # Build Model Shell
        self.model = build_model(self.model_params, text_aligner,
...
if __name__ == "__main__":
    synthesizer = StyleTTS2Inference(
        config_path="Models/LibriTTS/config.yml", model_path="Models/LibriTTS/epoch_2nd_00074.pth")

    ref_style = synthesizer.compute_style("Models/LibriTTS/Sam Altman.wav")
